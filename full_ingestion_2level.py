#!/usr/bin/env python3
"""Full ingestion with 3-level Rules parser"""
import sys
...
print("=" * 70)
print("FULL INGESTION - 3-LEVEL RULES STRUCTURE")
print("=" * 70)
...
# ============================================================================
# 2. CASES (first 10 for testing)
# ============================================================================
print("\n[2/3] Processing Cases (first 10)...")
...
# ============================================================================
# 3. RULES OF COURT (3-LEVEL PARSER)
# ============================================================================
...
try:
    ...
    if inserted > 0 and orphans == 0:
        ...
        print("\n🎉 Database ready for Week 4 - Interpretation Links!")
    else:
        print("\n⚠ Check results above")
